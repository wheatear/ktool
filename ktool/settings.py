"""
Django settings for ktool project.
...
SECRET_KEY = 'g$igoatw4x#s%e_eh&pjo_%%%j$j*n$3(0o9=(mg%bk%*00ir&'
...
WSGI_APPLICATION = 'ktool.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            ...
            'filename': os.path.join(BASE_DIR, 'log/sendkt.log'),     #日志输出文件
            'when': 'midnight',                  #文件大小
            'interval': 1,
            'backupCount': 5,                         #备份份数
            # 'datefmt': '%Y%m%d%H%M%S',
